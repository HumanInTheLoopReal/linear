...
export async function createMilestone(
  ...
  // CreateProjectMilestone declares flat variables and assembles the input
  // object inside the document, so the input fields are spread here.
...
export async function updateMilestone(
  ...
  // UpdateProjectMilestone declares flat variables like the create mutation.
