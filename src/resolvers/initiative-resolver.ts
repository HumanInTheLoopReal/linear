...
/**
 * ARCHITECTURAL EXCEPTION: The Linear SDK does not expose initiative relation
 * or initiative-project link lookup by endpoint pair. These resolvers use the
 * generated GraphQL queries only to translate already-resolved UUID pairs into
 * the relation/link UUID required by delete mutations.
 */
...
/**
 * ARCHITECTURAL EXCEPTION: The Linear SDK cannot resolve an
 * initiative-project link by its already-resolved initiative/project UUID
 * pair, so this resolver uses the generated GraphQL lookup query.
 */
