...
describe("decryptToken", () => {
  ...
  it("decrypts tokens written with the pre-rebrand key material", () => {
    const encrypted =
      "v1:000102030405060708090a0b0c0d0e0f:b095b2e6895d5cc4c9bc40acbe10ea3593fcf8bf84ac4d15709aa92952a63be2";
    expect(decryptToken(encrypted)).toBe("lin_api_legacy_key");
  });
