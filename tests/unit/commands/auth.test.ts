...
vi.mock("../../../src/common/context.js", () => ({
  ...
  // Tests exercise the JSON path of outputResult so the existing
  // assertions on console.log + JSON.parse stay valid. The text path
  // is covered separately in tests/unit/commands/auth-format.test.ts.
  getRootOpts: vi.fn(() => ({ apiToken: "test-token", json: true })),
}));
